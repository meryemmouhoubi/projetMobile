...
public class NetworkModule {
    ...
    //La classe NetworkModule fournit une instance d'OkHttpClient, une instance de Retrofit et une instance de
    //l'interface APIService qui sont nécessaires pour la communication avec l'API PokéAPI.
    @Provides
    @Singleton
