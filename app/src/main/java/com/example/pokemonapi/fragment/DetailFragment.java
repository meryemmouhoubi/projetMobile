...
public class DetailFragment extends Fragment {
    //lier les éléments d'interface utilisateur (UI) du fragment dans le code Java.
    private FragmentDetailBinding fragmentDetailBinding;

    //afficher une liste de types de Pokémon dans un RecyclerView.
    private TypeRecyclerViewListAdapter typeRecyclerViewListAdapter;

    //utilisée pour récupérer les données des Pokémons.
    private DetailRepository detailRepository;
    //utilisée pour stocker et gérer les données des Pokémons dans le fragment.
   ...
   // Cette méthode initialise les variables d'instance et récupère les données du Pokémon
    //à afficher à partir de l'intent de l'activité
    //parente ou de l'état sauvegardé du fragment.
    @Override
...
//. Cette méthode crée et retourne la vue du fragment à partir de son layout XML et initialise
// le RecyclerView pour afficher les types de Pokémon.
    @Override
...
// Cette méthode enregistre le nom et l'image du Pokémon en cours d'affichage.
    @Override
...
//configure les éléments d'UI avec les données du Pokémon en cours d'affichage,
// y compris le nom, l'image, et la couleur de fond de la carte.
...
//la flèche de retour pour qu'elle ferme le fragment et revienne à l'activité parente.
...
// récupère les données du Pokémon à afficher à partir de l'API PokeAPI.
